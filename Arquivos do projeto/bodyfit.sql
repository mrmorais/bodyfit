...
CREATE SCHEMA IF NOT EXISTS `bodyfit` DEFAULT CHARACTER SET utf8 ;
USE `bodyfit` ;
...
-- -----------------------------------------------------
-- Table `bodyfit`.`categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bodyfit`.`categoria` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `bodyfit`.`pratica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bodyfit`.`pratica` (
  `id` BIGINT(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_pratica_categoria1_idx` (`categoria_id` ASC),
  CONSTRAINT `fk_pratica_categoria1`
    FOREIGN KEY (`categoria_id`)
    REFERENCES `bodyfit`.`categoria` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `bodyfit`.`avaliacao_marcada`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bodyfit`.`avaliacao_marcada` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `personal_id` BIGINT(11) NOT NULL,
  `aluno_id` BIGINT(11) NOT NULL,
  `data` DATE NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_avaliacao_marcada_personal1_idx` (`personal_id` ASC),
  INDEX `fk_avaliacao_marcada_aluno1_idx` (`aluno_id` ASC),
  CONSTRAINT `fk_avaliacao_marcada_personal1`
    FOREIGN KEY (`personal_id`)
    REFERENCES `bodyfit`.`personal` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_avaliacao_marcada_aluno1`
    FOREIGN KEY (`aluno_id`)
    REFERENCES `bodyfit`.`aluno` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `bodyfit`.`exercicio` (
  `id` BIGINT(11) NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NOT NULL,
  `image` VARCHAR(244) NULL DEFAULT NULL,
