...
--
-- Host: localhost
-- Generation Time: Oct 14, 2015 at 03:56 PM
...
INSERT INTO `execucao` (`id`, `treino_id`, `treino_personal_id`, `treino_aluno_id`, `series`, `repeticoes`, `cadencia`, `tempo`, `academia_has_pratica_pratica_id`) VALUES
(3, 3, 1, 1, 3, 12, NULL, 0, 8),
(4, 3, 1, 1, 3, 12, NULL, 0, 47),
(5, 3, 1, 1, 3, 12, NULL, 0, 10),
(6, 3, 1, 1, 3, 12, NULL, 0, 11),
(7, 3, 1, 1, 3, 12, NULL, 0, 13),
(8, 3, 1, 1, 3, 12, NULL, 0, 17),
(9, 3, 1, 1, 3, 12, NULL, 0, 20),
(10, 3, 1, 1, 3, 12, NULL, 0, 23);
...
INSERT INTO `treino` (`id`, `inico`, `fim`, `ativo`, `aluno_id`, `personal_id`) VALUES
(3, '2015-09-23', '0000-00-00', 1, 1, 1);
...
ALTER TABLE `execucao`
  ADD PRIMARY KEY (`id`,`academia_has_pratica_pratica_id`), ADD KEY `fk_execucao_treino1_idx` (`treino_id`,`treino_personal_id`,`treino_aluno_id`), ADD KEY `fk_execucao_academia_has_pratica1_idx` (`academia_has_pratica_pratica_id`);
