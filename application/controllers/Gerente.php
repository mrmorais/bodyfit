...
class Gerente extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('gerente/home', array("user"=>$this->usuarioLogado));
	}
	
	public function codigo_acesso() {
		$this->auth();
		//Abrir página inicial
		$this->load->view('gerente/codigo_acesso', array("user"=>$this->usuarioLogado));
	}
