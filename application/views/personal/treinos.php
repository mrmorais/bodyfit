				...
				<div class="row">
					<div class="col-md-12 panel">
						...
						<table class="table">
								...
								<tbody class="exercicio-row">
								<?php
								if($treinos!=false) {
									foreach($treinos as $exe) {
										echo "<tr class='treino'>".
											"<td class='info-id-treino' >".$exe['id']."</td>".
											"<td>".$exe['nome']."</td>".
											"<td>".$exe['sexo']."</td>".
											"<td><a href='?/Personal/treino/".$exe['id']."' class='btn btn-primary'>Montar treino</a></td>".
											"</tr>";
									}
								}
								?>
							...
							if($treinos==false) {
								echo "<tr>";
								echo "<td colspan='4'><center><h2>Nenhum aluno possui um treino especificado</h2><br>
								Fale com seus alunos e elaborem juntos um treino <a href='?/Personal/inbox/' class='btn btn-info'>Inbox</a></center></td>";
								echo "</tr>";
							}
							?>
						</table>
